...
st.sidebar.image('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT632JT-cShGKqKEUEK8ZrUbHJQME8r1vVKQw&usqp=CAU')
...
if (user_menu == 'Athlete wise Analysis'):
    ...
    famous_sports = ['Basketball', 'Judo', 'Football', 'Tug-Of-War', 'Athletics',
                     ...
                     'Rhythmic Gymnastics', 'Rugby Sevens', 'Beach Volleyball', 'Triathlon', 'Rugby',
                     'Polo', 'Ice Hockey']
